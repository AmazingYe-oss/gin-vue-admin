...
// timeEncoder json 格式输出 RFC3339Nano 且不带 prefix——采集器(Vector/Fluent Bit/
// Promtail 等)可直接解析时间戳,这是日志"采集就绪"的关键;console 保持人类可读格式。
func (c *Zap) timeEncoder() zapcore.TimeEncoder {
	if c.Format == "json" {
